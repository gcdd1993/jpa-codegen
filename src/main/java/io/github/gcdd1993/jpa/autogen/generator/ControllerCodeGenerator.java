...
public class ControllerCodeGenerator extends BaseCodeGenerator {
    ...
    public ControllerCodeGenerator(ApplicationContext applicationContext) {
    ...
    public void beforeGenerate() {
        ...
        String packageName = applicationContext.getOrDefaultAttribute(AttributeKey.CONTROLLER_PACKAGE, entityInfo.getPackageName() + DEFAULT_PACKAGE_NAME_SUFFIX, String.class);
        applicationContext.setAttribute(AttributeKey.PACKAGE_NAME, packageName);

        // targetFileName
        applicationContext.setAttribute(AttributeKey.TARGET_CLASS_NAME, entityInfo.getSimpleName() + applicationContext.getAttribute(AttributeKey.CONTROLLER_SUFFIX));
        applicationContext.setAttribute(AttributeKey.TEMPLATE_NAME, applicationContext.getAttribute(AttributeKey.CONTROLLER_TEMPLATE));
    }
